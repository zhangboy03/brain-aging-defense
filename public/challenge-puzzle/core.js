(function () {
  ...
  const PUZZLES = [
    ...
    {
      id: 'show-r4-square-lock',
      title: '节目复刻 R4：方块锁',
      note: '来源：EP4 Challenge Puzzle Round 4 规则帧与过程说明。两个 2x2 正方形块不能同时放入，最高 Step 2。',
      maxStep: 2,
      board: [
        '#.#.###',
        '#####.#',
    ...
    {
      id: 'show-r5-double-vortex',
      title: '节目复刻 R5：双旋涡',
      note: '来源：EP4 Challenge Puzzle Round 5 规则帧与赛后复盘。场上 Step 5 成功；复盘确认 Step 6 可行，Step 7 不成立。',
      maxStep: 6,
      board: [
        '...###...   ...###...',
        '...#.....   .....#...',
    ...
    {
      id: 'show-r7-final-bars',
      title: '节目复刻 R7：长条终局',
      note: '来源：EP4 Challenge Puzzle Round 7 规则帧与片尾复盘。现场 Step 6 限时失败不等于不可行；按题面求解最高 Step 7，Step 8 面积超出。',
      maxStep: 7,
      board: [
        '#####',
        '#####',
